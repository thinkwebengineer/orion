  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      <div>
        ...
        <p className="text-zinc-400 text-sm mt-1">Add a new product to your catalog</p>
      </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                placeholder="e.g., liquid-cultures, apparel"
                className="w-full px-3 py-2 rounded-lg border border-zinc-700 bg-zinc-900 text-sm text-white placeholder-zinc-500 focus:outline-none focus:ring-1 focus:ring-[#FFD700] focus:border-[#FFD700]"
              />
            </div>
            ...
            <div>
              <label className="block text-xs text-zinc-500 mb-1.5">
                Inventory <span className="text-zinc-600">(leave empty for made-to-order)</span>
              </label>
              <input
                type="number"
                min="0"
