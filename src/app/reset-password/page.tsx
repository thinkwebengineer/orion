      ...
      <div className="flex min-h-[60vh] items-center justify-center px-4">
        <div className="w-full max-w-md text-center">
          <div className="rounded-xl border border-zinc-800 bg-zinc-900/50 p-8 gold-border-glow">
            ...
            <Link href="/forgot-password" className="inline-block rounded-lg bg-[#FFD700] px-6 py-2.5 text-sm font-semibold text-black transition-all hover:bg-[#FFC000]">
              Request New Link
            </Link>
          </div>
        </div>
    ...
    <div className="flex min-h-[60vh] items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="mb-8 text-center">
          <h1 className="gold-glow text-3xl font-bold tracking-tight text-[#FFD700]">Set New Password</h1>
          <p className="mt-2 text-sm text-zinc-400">Choose a new password for your account</p>
        </div>
        <div className="rounded-xl border border-zinc-800 bg-zinc-900/50 p-8 gold-border-glow">
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label htmlFor="password" className="mb-1.5 block text-sm font-medium text-zinc-300">New Password</label>
            ...
            {password && confirmPassword && password !== confirmPassword && (
              <div className="rounded-lg border border-red-900/50 bg-red-900/20 px-4 py-3 text-sm text-red-400">Passwords do not match</div>
            )}
            {error && (
              <div className="rounded-lg border border-red-900/50 bg-red-900/20 px-4 py-3 text-sm text-red-400">{error}</div>
            )}
          ...
          <p className="text-center text-sm text-zinc-400">
            ...
            <Link href="/login" className="font-medium text-[#FFD700] transition-colors hover:text-[#FFC000]">Sign in</Link>
          </p>
        </div>
      </div>
    </div>
